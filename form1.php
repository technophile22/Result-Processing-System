...
<div class="container" >
  ...
  <form class="form" action="form1.php" id="form"  method="post">
    ...
    <fieldset class="form-fieldset ui-input __second">
      <input type="text" id="Fathers_Name" tabindex="0" />
      <label for="Fathers_Name">
        <span data-text="Father's Name">Father's Name</span>
      </label>
    </fieldset>
    ...
    <fieldset class="form-fieldset ui-input __third">
      ...
      <label for="Mothers_Name">
        <span data-text="Mother's Name">Mother's Name</span>
      </label>
    </fieldset>
    ...
    <fieldset class="form-fieldset ui-input __fifth">
      ...
      <label for="Roll_Number">
        <span data-text="Roll Number">Roll Number</span>
      </label>
    </fieldset>

    <div class="form-footer">
      <button class="btn" id = "next1" type="submit" >Next</button>
    </div>
  </form>
</div>
		...
		$('#next1').click(function(e){
			...
			var Roll_Number 	= $('#Roll_Number').val();
				...
				$.ajax({
					type: 'POST',
					url: 'process1.php',
					data: {Name: Name,Fathers_Name: Fathers_Name,Mothers_Name: Mothers_Name,Date_of_birth: Date_of_birth,Roll_Number:Roll_Number },
            ...
            Swal.fire({
                      ...
                      window.location = "http://localhost/form/form2.php";
                  });
          },
          error: function(data){
						Swal.fire({
